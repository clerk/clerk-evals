...
export const graders = {
  ...
  imports_experimental_checkout: async (actual) => actual.includes('@clerk/nextjs/experimental'),
  uses_checkout_provider: async (actual) => actual.includes('CheckoutProvider'),
