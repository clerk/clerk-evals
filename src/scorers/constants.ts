...
const PROMPT_VERIFY_WEBHOOK_CALLED_CORRECTLY = "Does the solution call verifyWebhook with a single request parameter?";
const PROMPT_HTTP_RESPONSES = "After verification, does the handler return a 200 response, and does it return a 400-level response when verification fails?";
